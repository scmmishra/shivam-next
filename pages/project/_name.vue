<template>
  <div class="max-w-4xl mx-auto px-4 sm:px-0">
    <div class="max-w-2xl mx-auto py-10 md:py-16 xl:py-20 text-center">
      ...
      <h1 class="text-xl md:text-4xl xl:text-5xl font-extrabold mb-0 ">{{ project.title }}</h1>
      <p class="max-w-lg mx-auto text-center mt-4 mb-2 text-gray-500 text-xl font-serif">{{ project.subtitle }}</p>
